if ( NOT Fortran_FLAGS_INIT )
  ...
  if ( "${CMAKE_Fortran_COMPILER_ID}" MATCHES "Intel" )
    ...
    if ( ENABLE_COMPILE_TIME_WARNINGS )
      ...
      set ( CMAKE_Fortran_FLAGS "${CMAKE_Fortran_FLAGS} ${real8} ${fpp} ${pre}warn ${pre}stand${spc}f08 ${Q}diag-disable${spc}7601 ${Q}diag-disable${spc}5142" )
    endif ()
    if ( ENABLE_RUNTIME_CHECKS )
      set ( CMAKE_Fortran_FLAGS "${CMAKE_Fortran_FLAGS} -check all" )
    endif ()
  elseif ( "${CMAKE_Fortran_COMPILER_ID}" MATCHES "GNU" )
    set ( CMAKE_Fortran_FLAGS "${CMAKE_Fortran_FLAGS} -fdefault-real-8 -ffree-line-length-0 -cpp -Wimplicit-interface" )
